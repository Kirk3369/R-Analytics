...
```{r}
#4. URLs
urls <- c('https://www.amazon.com/s?k=PC&crid=3O0HDEISP3NAZ&sprefix=pc%2Caps%2C610&ref=nb_sb_noss_1', 
...
#The code extracts data from Amazon product listing pages based on different search queries, such as "PC's", "Graphics Cards", "Keyboards", "Mouse", and "Motherboards". For each URL, the following information is extracted: Product Name along with its description(if available), Rating, and Price.
```
...
combined_df$Category <- rep(c("PC's", "Graphics Cards", "Keyboards", "Mouse", "Motherboards"), each = 30)
